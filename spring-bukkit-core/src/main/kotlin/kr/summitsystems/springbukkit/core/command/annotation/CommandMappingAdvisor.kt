...
import kr.summitsystems.springbukkit.core.command.CommandContext
...
class CommandMappingAdvisor(
    ...
    @Pointcut("execution(* kr.summitsystems.springbukkit.core.command.CommandExecutor.executeCommand(..))")
    fun pointcut() {
    }
